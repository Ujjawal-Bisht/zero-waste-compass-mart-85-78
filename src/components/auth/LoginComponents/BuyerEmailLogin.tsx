    ...
    <>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input 
                          ...
                          className="pl-10 input-animated-border transition-all duration-300 focus:ring-2 ring-blue-300" 
                          {...field} 
                        />
                      </div>
                    </FormControl>
                ...
                <FormItem>
                  ...
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      placeholder="******" 
                      className="pl-10 pr-10 input-animated-border transition-all duration-300 focus:ring-2 ring-blue-300" 
                      {...field} 
                    />
                    <motion.div 
          ...
          {/* Redesigned reCAPTCHA with fixed sizing and better interaction */}
          <motion.div
          ...
          >
            <div className="captcha-container w-full max-w-md mx-auto overflow-hidden rounded-lg shadow-sm bg-gradient-to-br from-blue-50 via-white to-indigo-50 border border-blue-100 p-2">
              <motion.div
              ...
              >
                ...
                />
                <motion.div 
                  className="absolute inset-0 bg-blue-400 opacity-0 rounded-lg pointer-events-none"
                  animate={{ 
                    opacity: [0, 0.05, 0],
                    scale: [1, 1.01, 1]
                  }}
          ...
          >
            <Button
              type="submit"
              className="w-full zwm-gradient hover:opacity-90 transition-all duration-300 h-11 text-lg font-medium"
