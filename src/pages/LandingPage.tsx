...
import { ArrowRight, Upload, MessageCircle, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold font-heading text-gray-900">Zero Waste Mart</span>
            </div>
      ...
      <section className="relative">
        <div className="bg-gradient-to-r from-zwm-primary to-zwm-secondary overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden opacity-20">
            <div className="absolute -right-5 -top-20 w-96 h-96 rounded-full bg-white opacity-20 animate-float"></div>
            <div className="absolute right-20 bottom-10 w-64 h-64 rounded-full bg-white opacity-10 animate-float" style={{ animationDelay: '0.5s' }}></div>
            <div className="absolute left-20 top-40 w-72 h-72 rounded-full bg-white opacity-10 animate-float" style={{ animationDelay: '1s' }}></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {/* Feature 1 */}
            <div className="zwm-card p-8 text-center">
              <div className="mx-auto h-16 w-16 rounded-full bg-zwm-primary bg-opacity-10 flex items-center justify-center mb-6">
            ...
            {/* Feature 2 */}
            <div className="zwm-card p-8 text-center">
              <div className="mx-auto h-16 w-16 rounded-full bg-zwm-secondary bg-opacity-10 flex items-center justify-center mb-6">
            ...
            {/* Feature 3 */}
            <div className="zwm-card p-8 text-center">
              <div className="mx-auto h-16 w-16 rounded-full bg-zwm-accent bg-opacity-10 flex items-center justify-center mb-6">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            <div className="zwm-card p-8">
              ...
              <div className="h-2 w-full bg-gray-100 rounded-full mt-4">
                <div className="h-full bg-zwm-primary rounded-full" style={{ width: '80%' }} />
              </div>
            </div>
            <div className="zwm-card p-8">
              ...
              <div className="h-2 w-full bg-gray-100 rounded-full mt-4">
                <div className="h-full bg-zwm-secondary rounded-full" style={{ width: '65%' }} />
              </div>
            </div>
            <div className="zwm-card p-8">
              ...
              <div className="h-2 w-full bg-gray-100 rounded-full mt-4">
                <div className="h-full bg-zwm-accent rounded-full" style={{ width: '45%' }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-zwm-primary to-zwm-secondary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold font-heading text-white">Join Zero Waste Mart Today</h2>
